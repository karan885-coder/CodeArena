...
const ProblemPage = () => {
 ...
 //added
        ...
        // console.log("Mapped Language:", langMap[selectedLanguage]);
        // console.log("Start Code:", response.data.startCode);

        const template = response.data.startCode.find(
        ...
        if (!template) {
            console.error("No matching language found!");
            return;
        }
...
//added
  ...
  useEffect(() => {
    if (problem) {
      const template = problem.startCode.find(
        sc => sc.language.toLowerCase() === langMap[selectedLanguage].toLowerCase()
      );
